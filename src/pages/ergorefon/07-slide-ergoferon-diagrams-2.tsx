    ...
    <Frame
      ...
      footerText={
        <>
          ...
          антибіотикорезистентності, ЗУ «Педіатрія» №1 (48), березень 2019 р.,
          с. 8-9; А.В. Возняк, Оптимізація лікування гострих респіраторних
          інфекцій у дітей, ЗУ
          <br /> «Педіатрія», № 3 (50), 2019 р.; Геппе Н.А. і співавт.,
          Лікування ГРВІ та Грипу в амбулаторно-поліклінічній практиці:
          результати міжнародної спостережної неінтервенційної програми
          "Ермітаж«, Терапія, №8 (18), 2017 р.
        </>
      }
    >
