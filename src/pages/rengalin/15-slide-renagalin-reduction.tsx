    ...
    >
      ...
      <div className="content-15">
        ...
        <BellInfo
          text={
            <>
              <ColoredText pageColor="rengalin">Прийом Ренгаліна</ColoredText>{" "}
              протягом трьох днів{" "}
              <ColoredText pageColor="rengalin">
