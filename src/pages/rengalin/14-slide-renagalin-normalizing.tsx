...
const Page: React.FC = ({}) => {
  return (
    <Frame
      ...
      footerText="М.М.Кочуєва, ЗАСТОСУВАННЯ ПРЕПАРАТУ РЕНГАЛІН —НОВИЙ НАПРЯМОК У РЕГУЛЯЦІЇ КАШЛЮ, Новини медицини та фармації № 10 (728), 2020; У.Б. Чуловська, Сучасні підходи до діагностики та лікування продуктивного кашлю в амбулаторній практиці, Здоров’я України № 22 (515), Листопад 2021 р.; Л.Ф. Матюха, Ренгалін: застосування інноваційних технологій у лікуванні кашлю, Здоров’я України № 3 (496) , Лютий 2021 р. М. М. Кочуєва, І. І. Грек Ренгалін – нові можливості ефективної терапії кашлю, Здоров’я України № 4 (497), Лютий 2021 р"
      pageColor="rengalin"
    >
